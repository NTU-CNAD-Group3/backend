...
describe('Fab Controller – Unit Tests', () => {
  ...
  describe('getAllFabsController', () => {
    it('should call service and return all fabs on success', async () => {
      ...
      expect(mockRes.status).toHaveBeenCalledWith(200);
      expect(mockRes.json).toHaveBeenCalledWith(mockFabs);
    });
  ...
  describe('getFabController', () => {
    ...
    it('should return 500 if service throws an error', async () => {
      ...
      const mockError = new Error('Service failed');
      mockReq.query = { id: mockFabId };
      mockGetFab.mockRejectedValue(mockError);
      ...
      expect(fabService.getFab).toHaveBeenCalledWith(mockFabId);
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({ error: 'Can not get fab' });
    });
  });
  ...
  describe('createFabController', () => {
    ...
    it('should call service and return created fab on success', async () => {
      const mockName = 'FabC';
      const mockRoomNum = 5;
      const mockCreatedFab = { id: 3, name: mockName, roomnum: mockRoomNum };
      ...
      expect(mockRes.json).toHaveBeenCalledWith(mockCreatedFab);
    });
    ...
    it('should return 500 if service throws an error', async () => {
      ...
      const mockError = new Error('Service failed');
      mockReq.body = { name: mockName, roomNum: mockRoomNum };
      mockCreateFab.mockRejectedValue(mockError);
      ...
      expect(fabService.createFab).toHaveBeenCalledWith(mockName, mockRoomNum);
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({ error: 'Can not create fab' });
    });
  });
  ...
  describe('updateFabController', () => {
    ...
    it('should call service and return updated fab on success', async () => {
      ...
      expect(mockRes.status).toHaveBeenCalledWith(200);
      expect(mockRes.json).toHaveBeenCalledWith(mockUpdatedFab);
    });
    ...
    it('should return 500 if service throws an error', async () => {
      ...
      const mockError = new Error('Service failed');
      mockReq.body = { id: mockId, name: mockName, roomNum: mockRoomNum };
      mockUpdateFab.mockRejectedValue(mockError);
      ...
      expect(fabService.updateFab).toHaveBeenCalledWith(mockId, mockName, mockRoomNum);
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({ error: 'Can not update fab' });
    });
  });
  ...
  describe('deleteFabController', () => {
    ...
    it('should call service and return deleted fab on success', async () => {
      ...
      expect(mockRes.status).toHaveBeenCalledWith(200);
      expect(mockRes.json).toHaveBeenCalledWith(mockDeletedFab);
    });
    ...
    it('should return 500 if service throws an error', async () => {
      ...
      const mockError = new Error('Service failed');
      mockReq.body = { name: mockName };
      mockDeleteFab.mockRejectedValue(mockError);
      ...
      expect(fabService.deleteFab).toHaveBeenCalledWith(mockName);
      expect(mockRes.status).toHaveBeenCalledWith(500);
      expect(mockRes.json).toHaveBeenCalledWith({ error: 'Can not delete fab' });
    });
  });
});
